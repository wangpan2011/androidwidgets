...
public class PredicateLayout extends ViewGroup {
    ...
    public PredicateLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.PredicateLayout);
        lineSpan = ta.getDimensionPixelSize(R.styleable.PredicateLayout_lineSpan, 0);
        ta.recycle();
    }
